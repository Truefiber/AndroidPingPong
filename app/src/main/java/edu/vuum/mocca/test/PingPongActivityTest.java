 ...
 *
 * @brief Implements a Robotium edu.vuum.mocca.test for the PingPongActivity.
 */
public class PingPongActivityTest
    ...
    /**
     * Called before each edu.vuum.mocca.test is run to perform the initialization.
     */
    ...
    public void testPlayPingPongButtonPress() throws Exception {
        ...
        Log.d("Test", outputTextView_.getText().toString());
